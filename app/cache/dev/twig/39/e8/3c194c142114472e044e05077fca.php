...
/* olivierBlogBundle:Blog:index.html.twig */
class __TwigTemplate_39e83c194c142114472e044e05077fca extends Twig_Template
{
...
<html lang=\"fr\">
    ...
    <body>
        ...
        <nav>
            ...
            <a href=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("olivierblog_voir", array("id" => $this->getContext($context, "id"))), "html", null, true);
        echo "\">Vers Article </a>
        </nav>
...
";
    ...
    {
        return "olivierBlogBundle:Blog:index.html.twig";
    }
    ...
    {
        return array (  51 => 25,  42 => 19,  35 => 15,  19 => 1,);
    }
}
